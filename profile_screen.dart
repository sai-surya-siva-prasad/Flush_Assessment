...
// late final String favoriteBathroom='';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    currentUser = widget.currentUser;
     final favoriteBathroom = globalFavoriteBathroom;
    if (favoriteBathroom != null) {
      // Use the favoriteBathroom value.
      print('Favorite Bathroom: $favoriteBathroom');
    }
  }
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        globalFavoriteBathroom ?? '', // Use the global variable here
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
